...
def get_radial_encoded_target(polygon, cx, cy, num_rays=10):
...
class RadialHead(nn.Module):
    def __init__(self, in_channels=256, num_rays=10):
        super().__init__()
...
class TotalTextDataset(Dataset):
    def __init__(self, img_dir, ann_dir, img_size=512, num_rays=10):
